...
# shellcheck shell=sh
_() { eval "\${_LOADED_$1-false}" || ! eval "_LOADED_$1=true"; }; _ BIN_10TO2_SH && return # shpp:source_guard
...
if eval test '"$0" = "${BASH_SOURCE-}"' || case ".${0##*[/\\]}." in (*.10to2.*) ;; (*) false;; esac # shpp:main_guard
then
