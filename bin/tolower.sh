...
# shellcheck shell=sh
_() { eval "\${_LOADED_$1-false}" || ! eval "_LOADED_$1=true"; }; _ BIN_TOLOWER_SH && return # shpp:source_guard
...
if eval test '"$0" = "${BASH_SOURCE-}"' || case ".${0##*[/\\]}." in (*.tolower.*) ;; (*) false;; esac # shpp:main_guard
then
