...
Then call the command with the message as an argument, like `${CLAUDE_SKILL_DIR}/commit-with-message.bash "$message"`. The command shows the user the message and makes a commit if the user permits.
